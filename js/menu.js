    ...
    <div class="shopping-cart-details">
        <div>
            ...
            <div class="shopping-cart-quantity">
                <button class="btn btn-primary"><i class="fa fa-minus decrease" id=${product.id
      }></i></button>
                <span id=${product.id}>${product.quantity}</span>
                <button class="btn btn-primary"><i class="fa fa-plus increase" id=${product.id
      }></i></button>
            </div>
        </div>
        ...
        <div>
            <span class="details-icon">
                <a href="shopSingle.html?productId=${product.id}&productType=${product.type
      }&productGender=${product.gender}"><i class="fa fa-pencil" id=${product.id
      }></i></a>
